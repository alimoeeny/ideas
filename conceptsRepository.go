...
func init() {
	...
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_NORMAL_PLATELET_COUNT)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HIGH_PLATELET_COUNT)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_LOW_PLATELET_COUNT)

	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_MEAN_PLATELET_VOLUME)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_NORMAL_MEAN_PLATELET_VOLUME)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HIGH_MEAN_PLATELET_VOLUME)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_LOW_MEAN_PLATELET_VOLUME)
	...
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_NEUTROPHIL_PERCENTAGE)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_LYMPHOCYTE_PERCENTAGE)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_MONOCYTE_PERCENTAGE)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_EOSINOPHIL_PERCENTAGE)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_BASOPHIL_PERCENTAGE)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_RETICULOCYTE_PERCENTAGE)
	...
	// ----------------------
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_CBC_COMMENT_REACTICE_CHANGES)
	...
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HEMOGLOBIN_CONCENTRATION)
	DEFAULT_CONCEPT_REPO.SetAvailableUnitsForConceptWithID(CONCEPT_HEMOGLOBIN_CONCENTRATION.ID, UNIT_GRAMS_PER_DECILITER.ID)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_NORMAL_HEMOGLOBIN_CONCENTRATION)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HIGH_HEMOGLOBIN_CONCENTRATION)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_LOW_HEMOGLOBIN_CONCENTRATION)

	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HEMATOCRIT)
	DEFAULT_CONCEPT_REPO.SetAvailableUnitsForConceptWithID(CONCEPT_HEMATOCRIT.ID, UNIT_PERCENTAGE.ID)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_NORMAL_HEMATOCRIT)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HIGH_HEMATOCRIT)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_LOW_HEMATOCRIT)

	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_RDW)
	DEFAULT_CONCEPT_REPO.SetAvailableUnitsForConceptWithID(CONCEPT_RDW.ID, UNIT_PERCENTAGE.ID)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_NORMAL_RDW)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_HIGH_RDW)
	DEFAULT_CONCEPT_REPO.SetConcept(CONCEPT_LOW_RDW)

...
func init() {
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_UNKNOW)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_UNITLESS)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_PROBABILITY)
	...
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_COUNTS_PER_MICROLITER)
	...
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_CENTIMETER)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_MILLIMETER)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_MICROMETER)
	...
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_MICROGRAM_PER_LITER)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_MICROGRAM_PER_DECILITER)

	// IU
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_INTERNATIONAL_UNITS)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_INTERNATIONAL_UNITS_PER_LITER)

	// Time
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_NANOSECOND)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_DAY)
	DEFAULT_UNIT_REPO.SetUnit(*UNIT_TIMESTAMP)
}
